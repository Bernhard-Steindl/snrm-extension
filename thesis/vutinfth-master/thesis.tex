...
% Abstract: Write your abstract in German and English in a length of half a page to a full page and present the following aspects briefly and concisely: 
% the context of the work/task, the research question, the scientific method(s)/procedure(s) used and the central results.
\begin{abstract}
...
% Evaluation
% TODO should there be an evaluation? what topic?
