...
\frame{\includegraphics[trim=26.6cm 5cm 5cm 9cm,clip=true,width=0.96\textwidth]{Bildschirmfoto_2019-12-30_1.png}}
...
\begin{subfigure}[b]{0.96\textwidth}
    \centering
    % trim: left bottom right top
    \frame{\includegraphics[trim=0.2cm 1cm 18.5cm 0cm,clip=true,width=\textwidth]{Bildschirmfoto_2020-01-15_1.png}}
    \subcaption{Cost function of multiple different runs approaching the value zero}
    \label{fig:2020-01-15:cost-fn}
\end{subfigure}
\begin{subfigure}[b]{0.45\textwidth}
    \centering
    \frame{\includegraphics[trim=0.8cm 1.5cm 0cm 4cm,clip=true,width=\textwidth]{Bildschirmfoto_2020-01-15_2.png}}
...
\begin{subfigure}[b]{0.45\textwidth}
    \centering
    \frame{\includegraphics[trim=0.5cm 2cm 0cm 24.9cm,clip=true,width=\textwidth]{Bildschirmfoto_2020-01-15_3.png}}
...
\begin{subfigure}[b]{0.96\textwidth}
    \centering
    % trim: left bottom right top
    \frame{\includegraphics[trim=0.2cm 0cm 1cm 0cm,clip=true,width=\textwidth]{Bildschirmfoto_2020-01-24_1.png}}
    \subcaption{Cost function during training and validation approaching 0, but with oscillations}
    \label{fig:2020-01-24:cost-fn}
\end{subfigure}
\begin{subfigure}[b]{0.45\textwidth}
    \centering
    \frame{\includegraphics[trim=0.5cm 0cm 24cm 19cm,clip=true,width=\textwidth]{Bildschirmfoto_2020-01-24_2.png}}
...
\begin{subfigure}[b]{0.45\textwidth}
    \centering
    \frame{\includegraphics[trim=24.5cm 19cm 0cm 0cm,clip=true,width=\textwidth]{Bildschirmfoto_2020-01-24_2.png}}
...
\begin{subfigure}[b]{0.96\textwidth}
    \centering
    % trim: left bottom right top
    \frame{\includegraphics[trim=0.2cm 15cm 2cm 0.2cm,clip=true,width=\textwidth]{Bildschirmfoto_2020-02-07_relu-only-last_1.png}}
...
\begin{subfigure}[b]{0.45\textwidth}
    \centering
    \frame{\includegraphics[trim=0.5cm 15cm 32cm 0.2cm,clip=true,width=\textwidth]{Bildschirmfoto_2020-02-07_relu-only-last_3.png}}
...
\begin{subfigure}[b]{0.45\textwidth}
    \centering
    \frame{\includegraphics[trim=0.5cm 14.7cm 31cm 0cm,clip=true,width=\textwidth]{Bildschirmfoto_2020-02-07_relu-only-last_2.png}}
...
\begin{subfigure}[b]{0.45\textwidth}
    \centering
    \frame{\includegraphics[trim=24.8cm 3.8cm 1.5cm 19.5cm,clip=true,width=\textwidth]{Bildschirmfoto_2020-02-07_relu-all_1.png}}
...
\begin{subfigure}[b]{0.45\textwidth}
    \centering
    \frame{\includegraphics[trim=24.8cm 22.7cm 1.5cm 0.5cm,clip=true,width=\textwidth]{Bildschirmfoto_2020-02-07_relu-all_1.png}}
...
\begin{subfigure}[b]{0.96\textwidth}
    \centering
    \frame{\includegraphics[trim=0.5cm 5cm 1cm 0.5cm,clip=true,width=\textwidth]{Bildschirmfoto_2020-03-08_relu-only-last_1.png}}
...
\begin{subfigure}[b]{0.45\textwidth}
    \centering
    \frame{\includegraphics[trim=48.5cm 1cm 1.5cm 0.5cm,clip=true,width=\textwidth]{Bildschirmfoto_2020-03-08_relu-only-last_2.png}}
...
\begin{subfigure}[b]{0.45\textwidth}
    \centering
    \frame{\includegraphics[trim=24.5cm 1cm 25.5cm 0.5cm,clip=true,width=\textwidth]{Bildschirmfoto_2020-03-08_relu-only-last_2.png}}
...
\begin{subfigure}[b]{0.45\textwidth}
    \centering
    \frame{\includegraphics[trim=48.5cm 1.5cm 1cm 0.5cm,clip=true,width=\textwidth]{Bildschirmfoto_2020-03-08_relu-all_2.png}}
...
\begin{subfigure}[b]{0.45\textwidth}
    \centering
    \frame{\includegraphics[trim=24.5cm 1.5cm 25cm 0.5cm,clip=true,width=\textwidth]{Bildschirmfoto_2020-03-08_relu-all_2.png}}
...
\todo{@Sebastian: Stimmt das bzgl. AIR triples.train.tsv? Sollen wir es anders beschreiben?}
...
\todo{@Sebastian: Sollen wir erklären wie diese Datasets generiert/gesampled wurden? Files s. nicht mehr auf OwnCloud, reicht Beschreibung?}
...
\begin{subfigure}[b]{0.45\textwidth}
    \centering
    \frame{\includegraphics[trim=78.2cm 25cm 6.8cm 25cm,clip=true,width=\textwidth]{Bildschirmfoto_2020-03-10_relu-only-last_1.png}}
...
\begin{subfigure}[b]{0.45\textwidth}
    \centering
    \frame{\includegraphics[trim=54.2cm 25cm 30.8cm 25cm,clip=true,width=\textwidth]{Bildschirmfoto_2020-03-10_relu-only-last_1.png}}
...
% image of tensorboard_snrm_2020-03-15.zip (tensorboard file)
% image of 2020-03-17_tensorboard_snrm_only_l1_reg 2 (tensorboard file)    
\begin{figure}[htbp]
\centering
% trim: left bottom right top
\begin{subfigure}[b]{0.45\textwidth}
    \centering
    \frame{\includegraphics[trim=30cm 29.5cm 54.8cm 20cm,clip=true,width=\textwidth]{Bildschirmfoto_2020-03-15_1.png}}
    \subcaption{Cost function of multiple runs with different values for the regularization terms $\lambda_{doc}$ and $\lambda_{query}$. The different runs settle down to different values, but do not approach 0.}
    \label{fig:2020-03-15:cost-fn-different-regularization-terms}
\end{subfigure}
\hspace{0.042\textwidth}
\begin{subfigure}[b]{0.45\textwidth}
    \centering
    \frame{\includegraphics[trim=30cm 29.5cm 54.8cm 20cm,clip=true,width=\textwidth]{Bildschirmfoto_2020-03-17_1.png}}
    \subcaption{Costs settle down to a value around 400, where the model's loss is computed without the hinge loss, but the cost equals the l1 regularization.}
    \label{fig:2020-03-17:cost-fn-only-l1-regularization-without-hinge-loss}
\end{subfigure}
\newline
\begin{subfigure}[b]{0.45\textwidth}
    \centering
    \frame{\includegraphics[trim=78.2cm 23.4cm 6.8cm 26.8cm,clip=true,width=\textwidth]{Bildschirmfoto_2020-03-15_2.png}}
    \subcaption{Representation sparsity of multiple runs with different values of $\lambda_{doc}$ and $\lambda_{query}$ for query batches do not show much differences. The query sparsity is on average at about 0.45.}
    \label{fig:2020-03-15:sparsity-query-repr}
\end{subfigure}
\hspace{0.042\textwidth}
\begin{subfigure}[b]{0.45\textwidth}
    \centering
    \frame{\includegraphics[trim=54.2cm 23.4cm 30.8cm 26.8cm,clip=true,width=\textwidth]{Bildschirmfoto_2020-03-15_2.png}}
    \subcaption{Representation sparsity of multiple runs with different values of $\lambda_{doc}$ and $\lambda_{query}$ for document batches do not show much differences. The sparsity is on average at about 0.08.}
    \label{fig:2020-03-15:sparsity-doc-repr}
\end{subfigure}
% Remove the [...] argument if the original caption should be used in the figure list.
...
\label{fig:2020-03-15:cost-fn-query-doc-repr-sparsity} % \label has to be placed AFTER \caption (or \subcaption) to produce correct cross-references.
\end{figure}
...
% image of 2020-03-18_tensorboard_reduced_dims_bias 2 (tensorboard file)
\begin{figure}[htbp]
\centering
% trim: left bottom right top
\begin{subfigure}[b]{0.96\textwidth}
    \centering
    \frame{\includegraphics[trim=29.5cm 15.5cm 7cm 20cm,clip=true,width=\textwidth]{Bildschirmfoto_2020-03-18_1.png}}
    \subcaption{Cost function of a run with a convolution bias and one without a bias. The run without a bias settled down at around 100, whereas the other reached zero. Note that the cost equals the L1 regularization, because no hinge-loss was used for the loss computation for this experiment.}
    \label{fig:2020-03-18:relu-only-last:cost-fn}
\end{subfigure}
\begin{subfigure}[b]{0.45\textwidth}
    \centering
    \frame{\includegraphics[trim=78.2cm 23.4cm 6.8cm 26.8cm,clip=true,width=\textwidth]{Bildschirmfoto_2020-03-18_2.png}}
    \subcaption{Representation sparsity for query batches shows that the model with a convolution bias nears 1 just after a few steps, but the one without a bias varies around 0.40.}
    \label{fig:2020-03-18:relu-only-last:sparsity-query-repr}
\end{subfigure}
\hspace{0.042\textwidth}
\begin{subfigure}[b]{0.45\textwidth}
    \centering
    \frame{\includegraphics[trim=54.2cm 23.4cm 30.8cm 26.8cm,clip=true,width=\textwidth]{Bildschirmfoto_2020-03-18_2.png}}
    \subcaption{Representation sparsity for document batches shows similar to the query sparsity, that the model with a convolution bias nears 1 after a few steps.}
    \label{fig:2020-03-18:relu-only-last:sparsity-doc-repr}
\end{subfigure}
% Remove the [...] argument if the original caption should be used in the figure list.
\caption[Costs function and sparsity of two runs either with a convolution bias or without a bias of a model comprising sum reduction for hinge loss' logits computation, no dropout, ReLu only after the last layer, and only using the L1 regularization for the loss computation]
{Cost functions and representation sparsity of query and document batches for two runs with either a convolution bias (orange) or without a bias (blue) of a model comprising no dropout, mean reduction instead of sum reduction for the hinge loss' logit computation, a ReLu activation function only after the last convolution layer and only using the L1 regularization as loss (that is without using the hinge-loss. For both runs the regularization terms $\lambda_{doc}=0.9$ and $\lambda_{query}=0.0$ were used.)}
\label{fig:2020-03-18:relu-only-last:cost-fn-query-doc-repr-sparsity} % \label has to be placed AFTER \caption (or \subcaption) to produce correct cross-references.
\end{figure}
...
% images of tensorboard_2020-04-06.zip (tensorboard file)
\begin{figure}[htbp]
\centering
% trim: left bottom right top
\begin{subfigure}[b]{0.96\textwidth}
    \centering
    \frame{\includegraphics[trim=29.5cm 13.5cm 7cm 22cm,clip=true,width=\textwidth]{Bildschirmfoto_2020-04-06_1.png}}
    \subcaption{Cost function of multiple runs with different values for the regularization terms $\lambda_{doc}$ and $\lambda_{query}$ show that the function nears 0.5.}
    \label{fig:2020-04-06:relu-only-last:cost-fn}
\end{subfigure}
\begin{subfigure}[b]{0.45\textwidth}
    \centering
    \frame{\includegraphics[trim=78.2cm 21.4cm 6.8cm 28.8cm,clip=true,width=\textwidth]{Bildschirmfoto_2020-04-06_2.png}}
    \subcaption{Multiple runs with different values for the regularization terms $\lambda_{doc}$ and $\lambda_{query}$ show a controllable course of representation sparsity for query batches.}
    \label{fig:2020-04-06:relu-only-last:sparsity-query-repr}
\end{subfigure}
\hspace{0.042\textwidth}
\begin{subfigure}[b]{0.45\textwidth}
    \centering
    \frame{\includegraphics[trim=54.2cm 21.4cm 30.8cm 28.8cm,clip=true,width=\textwidth]{Bildschirmfoto_2020-04-06_2.png}}
    \subcaption{Multiple runs with different values for the regularization terms $\lambda_{doc}$ and $\lambda_{query}$ show a controllable course of representation sparsity for document batches.}
    \label{fig:2020-04-06:relu-only-last:sparsity-doc-repr}
\end{subfigure}
% Remove the [...] argument if the original caption should be used in the figure list.
\caption[Costs function and sparsity of multiple runs with different values of the regularization terms $\lambda_{doc}$ and $\lambda_{query}$  of a model comprising sum reduction for hinge loss' logits computation, no dropout, ReLu only after the last layer and a convolution bias]
{Cost function and representation sparsity of query and document batches for multiple runs with different values of the regularization terms $\lambda_{doc}$ and $\lambda_{query}$ of a model comprising no dropout, mean reduction instead of sum reduction for the hinge loss' logit computation, a ReLu activation function only after the last convolution layer and a convolution bias. For the red function $\lambda_{doc}=\lambda_{query}=0.0$ was used and for the others values in these intervals were selected $\lambda_{doc} = [1e-07, 4e-07]$ and $\lambda_{query} = [9e-13, 1e-11]$. The models under experiment had three hidden layers, each with 10 neurons, and 10,000 output units.}
\label{fig:2020-04-06:relu-only-last:cost-fn-query-doc-repr-sparsity} % \label has to be placed AFTER \caption (or \subcaption) to produce correct cross-references.
\end{figure}
...
\begin{subfigure}[b]{0.96\textwidth}
    \centering
    \frame{\includegraphics[trim=29.5cm 15.5cm 7cm 20cm,clip=true,width=\textwidth]{Bildschirmfoto_2020-04-11_1.png}}
    \subcaption{Cost function of multiple runs with different values for the regularization terms $\lambda_{doc}$ and $\lambda_{query}$ show that the function nears 0.5.}
    \label{fig:2020-04-11:relu-only-last:cost-fn}
\end{subfigure}
\begin{subfigure}[b]{0.45\textwidth}
    \centering
    \frame{\includegraphics[trim=78.2cm 23.4cm 6.8cm 26.8cm,clip=true,width=\textwidth]{Bildschirmfoto_2020-04-11_2.png}}
    \subcaption{Multiple runs with different values for the regularization terms $\lambda_{doc}$ and $\lambda_{query}$ show a non-controllable course of representation sparsity for document batches. The sparsity progresses too fast to 1.}
    \label{fig:2020-04-11:relu-only-last:sparsity-query-repr}
\end{subfigure}
\hspace{0.042\textwidth}
\begin{subfigure}[b]{0.45\textwidth}
    \centering
    \frame{\includegraphics[trim=54.2cm 23.4cm 30.8cm 26.8cm,clip=true,width=\textwidth]{Bildschirmfoto_2020-04-11_2.png}}
    \subcaption{Multiple runs with different values for the regularization terms $\lambda_{doc}$ and $\lambda_{query}$ show a non-controllable course of representation sparsity for document batches. Just after a few steps the sparsity is 1.}
    \label{fig:2020-04-11:relu-only-last:sparsity-doc-repr}
\end{subfigure}
% Remove the [...] argument if the original caption should be used in the figure list.
\caption[Costs function and non-controllable sparsity of multiple runs with different values of the regularization terms $\lambda_{doc}$ and $\lambda_{query}$ of a model comprising sum reduction for hinge loss' logits computation, no dropout, ReLu only after the last layer and a convolution bias]
{Cost function and non-controllable representation sparsity of query and document batches for multiple runs with different values of the regularization terms $\lambda_{doc}$ and $\lambda_{query}$ of a model comprising no dropout, mean reduction instead of sum reduction for the hinge loss' logit computation, a ReLu activation function only after the last convolution layer and a convolution bias. The models under experiment had two to three hidden layers, each with either 100 or 300 neurons, and 10,000 output units.}
\label{fig:2020-04-11:relu-only-last:cost-fn-query-doc-repr-sparsity} % \label has to be placed AFTER \caption (or \subcaption) to produce correct cross-references.
\end{figure}
...
% histograms of learned parameters - normal distribution initialization
\begin{figure}[htbp]
\centering
% trim: left bottom right top
\frame{\includegraphics[trim=23cm 6cm 18.5cm 11cm,clip=true,width=0.96\textwidth]{Bildschirmfoto_2020-09-29_5.png}}
...
% histograms of learned parameters - default pytoch convolution initialization 
\begin{figure}[htbp]
\centering
% trim: left bottom right top
\frame{\includegraphics[trim=23cm 6cm 18.5cm 11cm,clip=true,width=0.96\textwidth]{Bildschirmfoto_2020-09-29_6.png}}
...
Training with a neural network architecture with three or four hidden layers, each with 100 or 300 neurons per layer,
...
% image of 2020-09-30 Tensorboard snrm-pytorch initialization (tensorboard file)
\begin{figure}[htbp]
\centering
% trim: left bottom right top
\begin{subfigure}[b]{0.45\textwidth}
    \centering
    \frame{\includegraphics[trim=30.2cm 29.5cm 54.8cm 20cm,clip=true,width=\textwidth]{Bildschirmfoto_2020-09-29_1.png}}
    \subcaption{The orange cost function represents a model with parameter initializations of a normal distribution and no L1 regularization, whereas the others use PyTorch's default convolution layer parameter initialization. The cost function varies around 0.5.}
    \label{fig:2020-09-30:cost-fn}
\end{subfigure}
\hspace{0.042\textwidth}
\begin{subfigure}[b]{0.45\textwidth}
    \centering
    \frame{\includegraphics[trim=78.2cm 29.5cm 6.8cm 20cm,clip=true,width=\textwidth]{Bildschirmfoto_2020-09-29_1.png}}
    \subcaption{The dark blue and orange function represent runs with no L1 regularization and therefore the L1 regularization is constantly 0, whereas the light blue and red L1 regularization functions use different non-zero L1 regularization terms.}
    \label{fig:2020-09-30:l1-regularization}
\end{subfigure}
\newline
\begin{subfigure}[b]{0.45\textwidth}
    \centering
    \frame{\includegraphics[trim=78.2cm 23.4cm 6.8cm 26.8cm,clip=true,width=\textwidth]{Bildschirmfoto_2020-09-29_3.png}}
    \subcaption{Query sparsity is controllable for default convolution layer initialization by the regularization terms, but the orange function with normal distribution parameter initialization reaches quite fast 1.}
    \label{fig:2020-09-30:sparsity-query-repr}
\end{subfigure}
\hspace{0.042\textwidth}
\begin{subfigure}[b]{0.45\textwidth}
    \centering
    \frame{\includegraphics[trim=54.2cm 23.4cm 30.8cm 26.8cm,clip=true,width=\textwidth]{Bildschirmfoto_2020-09-29_3.png}}
    \subcaption{Document sparsity is controllable for default convolution layer initialization by the regularization terms, but the orange function with normal distribution parameter initialization reaches quite fast 1.}
    \label{fig:2020-09-30:sparsity-doc-repr}
\end{subfigure}
% Remove the [...] argument if the original caption should be used in the figure list.
...
\label{fig:2020-09-30:cost-fn-l1-reg-query-doc-repr-sparsity} % \label has to be placed AFTER \caption (or \subcaption) to produce correct cross-references.
\end{figure}

% image of 2020-09-30 Tensorboard snrm-pytorch initialization (tensorboard file)
% mean representation batch
\begin{figure}[htbp]
\centering
% trim: left bottom right top
\begin{subfigure}[b]{0.45\textwidth}
    \centering
    \frame{\includegraphics[trim=78.2cm 26.5cm 6.8cm 23.5cm,clip=true,width=\textwidth]{Bildschirmfoto_2020-09-29_2.png}}
    \subcaption{Mean representation values of query batches as a function of training steps. The orange function 
    represents a model with parameter initializations of a normal distribution and no L1 regularization, 
    whereas the others use PyTorch's default convolution layer parameter initialization.
    }
    \label{fig:2020-09-30:query-mean-repr}
\end{subfigure}
\hspace{0.042\textwidth}
\begin{subfigure}[b]{0.45\textwidth}
    \centering
    \frame{\includegraphics[trim=54.2cm 26.5cm 30.8cm 23.5cm,clip=true,width=\textwidth]{Bildschirmfoto_2020-09-29_2.png}}
    \subcaption{Mean representation values of document batches as a function of training steps. The orange function 
    represents a model with parameter initializations of a normal distribution and no L1 regularization, 
    whereas the others use PyTorch's default convolution layer parameter initialization.}
    \label{fig:2020-09-30:doc-mean-repr}
\end{subfigure}
% Remove the [...] argument if the original caption should be used in the figure list.
\caption[Mean representation values of query and document baches for multiple runs with different values of the regularization terms $\lambda_{doc}$ and $\lambda_{query}$ of a model comprising sum reduction for hinge loss' logits computation, no dropout, ReLu only after the last layer, a convolution bias and PyTorch's default convolution parameter initialization]
{Mean representation values of query and document batches for multiple runs with different values for the regularization terms $\lambda_{doc}$ and $\lambda_{query}$ of a model comprising no dropout, mean reduction instead of sum reduction for the hinge loss' logit computation, a ReLu activation function only after the last convolution layer, a convolution bias and PyTorch's default convolution parameter initialization. The models under test have four hidden layers (with 100, 100, 100 resp. 300 units) and 10,000 output dimensions. Further, the dark blue functions represent a run where the regularization terms are zero. The residual runs (light blue and red) use as regularization terms $(\lambda_{doc}=3e-8$, $\lambda_{query}=2e-10)$ resp. $(\lambda_{doc}=1e-8$, $\lambda_{query}=1e-10)$. The orange functions represent a run with the same model properties, except for using the normal distribution for parameter initialization and no L1 regularization.}
\label{fig:2020-09-30:query-doc-mean-repr} % \label has to be placed AFTER \caption (or \subcaption) to produce correct cross-references.
\end{figure}
