...
The code in Listing~\ref{tensorflow-logits-computation} shows part of the original SNRM source code for the logits computation for the hinge loss.
...
Subsequently, the packages according to Listing~\ref{installed-conda-pip-packages-colab-pytorch} 
    were installed using Conda and pip.
